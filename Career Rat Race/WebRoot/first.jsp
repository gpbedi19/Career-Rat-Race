...
<div class='outer'>
  ...
  <div class='login'>
    ...
    <form id="loginform" method="post" action="Mail.jsp">
      
Username<input type="text" name="c1" /><br/>
Email id<input type="text" name="c2" /><br/>
Phone number<input type="text" name="c3"/><br/>
