...
<div class='outer'>
  ...
  <div class='login'>
    ...
    <form id="loginform" method="post" action="changeprocess.jsp">
          <input placeholder='Username' type='text' name="c1">
  
      <input placeholder='New Password' type='text' name="c2">
      <input placeholder='Confirm Password' type='password' name="c3">
