...
<a id="topp" href="index.jsp"><img id="toppimg" src="images/logo1.jpg" alt=""/>CareerRatRace</a>			</div>
	...
	<div class="menu">
     ...
     <div class="menu">
     <div class="wrap">
     <p class="about">About IAS</p><br/>
     <p id="content">
     1)IAS is the short form of Indian Administrative Service. It is one of the prestigious services among the 24 services like IPS, IFS etc for the which the UPSC conduct Civil Services Examination (CSE) for selecting the candidates. An officer selected into the IAS gets exposure in very diverse roles like the collector, commissioner, head of public sector units, chief secretary, cabinet secretary etc. Not only the experience and challenges, but also the scope of making positive changes in the life of millions in India makes IAS a unique career choice.<br/><br/>
     2)Even though the exam to be undertaken is popularly known as IAS exam, it is officially called UPSC Civil Services Exam. The UPSC CSE consists of 3 stages-Prelims, Mains, and Interview. Getting into IAS is not easy considering the competition involved, but not impossible for a candidate with right attitude and approach.<br/><br/>
     
     
     <p class="about">PAPER FORMAT</p><br/>
      1.    General Studies (150 marks)<br/>
      2.    Some optional subject  (300 marks)<Br/><br/>

     <p class="about">General Studies</p><Br/>

    1)Indian Polity & Economy<Br/>
    2)History of India including Indian National Movement<Br/>
    3)Indian and World Geography<Br/>
    4)Current Affairs of National and International Importance<Br/>
    5)General and day-to-day Science<br/>
    6)Mental Ability and Basics of Statistics etc.<br/><br/>
      
     <p class="about">Optional Subject</p><br/>


    Agriculture<Br/>
    Animal Husbandry and Veterinary Science<Br/>
    Botany<Br/>
    Chemistry<Br/>
...
<a href="ca1.html" id="c4"><img src="images/test3.png"/>&nbsp;&nbsp;&nbsp;Take a test</a><br/><br/><br/>
